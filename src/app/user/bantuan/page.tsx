        ...
        <div className='bantuan-legal-sub-container'>
            ...
            <div className="faq-accordion">
                <ul>
                    ...
                    <li>
                        <button type="button" onClick={() => setSelected(selected != 2 ? 2: 0)}>
                            <div className="header-button"> 
                                <div className='button-title'>
                                    <span className='my-icon icon-20'><HelpCircle /></span>
                        ...
                        <div className={`accordion-content ${selected === 2? `max-h-[400px]` : 'max-h-0'}`}>
                            <div className="content-area">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing 
                                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                    ...
                    <li>
                        <button type="button" onClick={() => setSelected(selected != 3 ? 3: 0)}>
                            <div className="header-button"> 
                                <div className='button-title'>
                                    <span className='my-icon icon-20'><HelpCircle /></span>
                        ...
                        <div className={`accordion-content ${selected === 3 ? `max-h-[400px]` : 'max-h-0'}`}>
                            <div className="content-area">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing 
                                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
                    ...
                    <li>
                        <button type="button" onClick={() => setSelected(selected != 4 ? 4: 0)}>
                            <div className="header-button"> 
                                <div className='button-title'>
                                    <span className='my-icon icon-20'><HelpCircle /></span>
                        ...
                        <div className={`accordion-content ${selected === 4 ? `max-h-[400px]` : 'max-h-0'}`}>
                            <div className="content-area">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing 
                                    elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
