                ...
                <div className='sub-area'>
                    <div className='form-area'>
                        ...
                        <div className='group-input'>
                            ...
                            <Input size='large' value={globals.userLogin.name} disabled className='disabled:bg-white disabled:text-neutral-700' />
                        </div>
                        <div className='group-input'>
                            <label>No Handphone</label>
                            <Input size='large' value={globals.userLogin.phone_number} disabled className='disabled:bg-white disabled:text-neutral-700'/>
                        </div>
                        <div className='group-input'>
                            <label>Email</label>
                            <Input size='large' value={globals.userLogin.email} disabled className='disabled:bg-white disabled:text-neutral-700'/>
                        </div>
                    </div>
                </div>
