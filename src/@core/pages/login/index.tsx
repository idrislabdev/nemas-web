...
import ModalLoginOTP from '@/@core/components/modals/modal-login-otp';
...
const LoginPageWrapper = (props: {
  ...
  const onLogin = async () => {
    ...
    axiosInstance
      ...
      .catch((error) => {
        if (error.response.data.partial_token) {
          setPartialCode(error.response.data.partial_token.toString());
    ...
    <main className="login-page sm:mobile-responsive md:mobile-responsive">
      <div className="main-section">
        <div className="main-container">
          ...
          <div className="horizontal-divider line one-line">
            <span className="text-[#17494E] text-[16px]/[26px]">Atau</span>
          </div>
          <div className="info-area">
            ...
            <div className="footer-info">
              <h5>
                Ayo berinvestasi emas bersama <span>Nemas</span>
              </h5>
      ...
      />
      <ModalLoginOTP
        isModalOpen={isModalOTPOpen}
        setIsModalOpen={setIsModalOTPOpen}
