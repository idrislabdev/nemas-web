...
const BeliEmasWaitingView = (props: {setView:Dispatch<SetStateAction<string>>}) => {
    const { setView } = props
    return (
        <div className='waiting-section'>
            <div className='main-container'>
                ...
                <div className='group-button'>
                    <button onClick={() => setView('success')}>Jual Emas Lagi</button>
...
export default BeliEmasWaitingView