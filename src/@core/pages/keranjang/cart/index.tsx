    ...
    <>
      ...
      <div className="main-section">
            ...
            {carts.map((item, index: number) => (
              <div className="cart" key={index}>
                ...
                <div className="detail-area">
                  ...
                  <div className="price">
                    <label>
                      Rp{formatterNumber(parseInt(item.total_price_round))}
                    </label>
                  </div>
                ...
                <div className="action">
                  <a onClick={() => deleteData(item.order_cart_detail_id)}>
                    <Trash01 />
                  </a>
                </div>
              </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                {/* <div
                  ...
                  onClick={() => setSelectedMethod('SAPX')}
                >
                ...
                >
                  ...
                  <p>
                    Ambil pesanan di outlet terdekat atau outlet lain pilihan
                    anda
                  </p>
                </div>
                <div
                  ...
                  onClick={() => setSelectedMethod('PAXEL')}
                >
                  <div className="payment-title">
                    <Image
                      src={`/images/courier.png`}
        ...
        <div className="footer-container">
          ...
          <button onClick={() => onCheckout()} disabled={selectedMethod == ''}>
            Checkout
          </button>
        </div>
      </div>
