...
import { IPayment, IVoucher } from '@/@core/@types/interface'
// import ModalPayment from '../modal-payment'
import ModalPin from '../modal-pin'
import ModalPayment from '../modal-payment'

const PaymentDetailTransaksiView = (props: {setView:Dispatch<SetStateAction<string>>}) => {
    const { setView } = props
...
export default PaymentDetailTransaksiView